...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/a_Education'))

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/html_OrangeHRM                  katalonfont_c9515e'))
